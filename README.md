...
- Ecomm Retail Schuster Case Study.ipynb: The python file with code and relevant comments
- Ecommerce Retail B2B Late payment prediction.pdf: Summary on approach towards model building in python nb
